...
<template>
  <div class="instance-card">
      ...
      <div>
        <div class="name">
          ...
          <i
            ...
            @click.stop="rename(data.id, data.name, update)"
          ></i>
        </div>
        <div class="os">
          操作系统:
          <i
            :style="{ color: osNameToIcon(data.osName).color }"
    ...
    <div class="progress">
      <span
        >Memory Usage: <b>{{ data.memoryUsage.toFixed(1) }}</b
        >GB</span
      >
      <el-progress
