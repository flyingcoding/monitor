...
<template>
  <div style="padding: 15px 20px; height: 100%">
    <div style="display: flex; flex-direction: column; height: 100%">
      <div>
        <div class="title"><i class="fa-solid fa-user-plus"></i> 添加新的子账户</div>
        <div class="desc">
          子账户同样用于管理服务器，其权限由管理员进行分配，子账户只能访问被分配到的服务器。
        </div>
        ...
        <div class="client-card" v-for="item in clients" :key="item.id">
          ...
          <div style="margin-left: 20px">
            ...
            <div style="font-size: 12px; color: grey">
              操作系统:
              <i
                :style="{ color: osNameToIcon(item.osName).color }"
      ...
      <div style="text-align: center; margin-top: 10px">
        <el-button @click="createSubAccount" type="success" :disabled="!valid" plain
          >确认创建
        </el-button>
      </div>
    </div>
