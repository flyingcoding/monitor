  ...
  <div class="security-root">
    <div class="security-row">
        ...
        <div class="info-card">
          ...
          >
            ...
            <div style="text-align: center">
              <el-button :icon="Switch" @click="resetPassword" type="success" :disabled="!valid"
                >立即重置密码</el-button
              >
            </div>
          </el-form>
      ...
      <div style="flex: 50%; display: flex; flex-direction: column; gap: 10px">
        <div class="info-card">
          ...
          <div v-if="accounts.length" style="text-align: center">
            <div v-for="item in accounts" :key="item.id" class="account-card">
              ...
              <el-button type="danger" :icon="Delete" @click="deleteAccount(item.id)" text
                >删除子账户</el-button
              >
            </div>
            <el-button :icon="Plus" type="primary" @click="createAccount = true" plain
              >添加更多子用户</el-button
            >
          </div>
          <div v-else>
            <el-empty :image-size="100" description="还没有任何子用户哦" v-if="store.isAdmin">
              <el-button :icon="Plus" type="primary" plain @click="createAccount = true"
                >添加子用户</el-button
              >
            </el-empty>
        ...
        <oidc-providers v-if="store.isAdmin" />
      </div>
